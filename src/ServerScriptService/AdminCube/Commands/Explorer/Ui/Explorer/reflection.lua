    ...
    <Item class="ReflectionMetadataClasses">
        ...
        <Item class="ReflectionMetadataClass">
            <Properties>
                ...
                <string name="ExplorerOrder">31</string>
                <string name="ClassCategory">GUI</string>
                <string name="PreferredParent">GuiBase2d</string>
                <bool name="FFlag">Path2DEnabled15</bool>
            </Properties>
        </Item>
        ...
        <Item class="ReflectionMetadataClass">
            ...
            <Item class="ReflectionMetadataProperties">
                ...
                <Item class="ReflectionMetadataMember">
                    <Properties>
                        <string name="Name">UniqueId</string>
        ...
        <Item class="ReflectionMetadataClass">
            ...
            <Item class="ReflectionMetadataProperties">
                <Item class="ReflectionMetadataMember">
                    <Properties>
                        <string name="Name">AvatarGestures</string>
                        <string name="FFlag">UserVRAvatarGestures</string>
                    </Properties>
                </Item>
            </Item>
        </Item>
